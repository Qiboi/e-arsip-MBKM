...
<div class="fixed w-full flex items-center justify-between h-14 text-black z-10 dark:text-white">
  ...
  <div class="flex justify-between items-center h-14 bg-grey-100 dark:bg-gray-800 header-right ">
    <div class="bg-white rounded items-center sm:w-full max-w-sm shadow-sm w-32  ml-4">
      <input type="search" name="" id="" placeholder="Search" class="relative w-32 sm:w-full pl-3 text-sm text-black outline-none border-2 border-gray-300 focus:outline-none bg-white" />
