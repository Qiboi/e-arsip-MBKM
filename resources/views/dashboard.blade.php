    ...
    <div x-data="setup()" :class="{ 'dark': isDark }">
        <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
          ...
          <div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
            ...
            <div class="flex justify-between items-center h-14 bg-sky-400 dark:bg-gray-800 header-right">
          ...
          <!-- Sidebar -->
          <div class="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bg-sky-500 dark:bg-gray-900 h-full text-black transition-all duration-300 border-none z-10 sidebar">
            <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
              <ul class="flex flex-col py-4 space-y-1">
                <li class="px-5 hidden md:block">
                  <div class="flex flex-row items-center h-8">
                    <div class="text-sm font-light tracking-wide text-slate-900 uppercase">Main</div>
                  </div>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul id="dropdown-example" class="hidden bg-sky-700 dark:bg-gray-800">
                      <li>
                        <a href="#"
                          class="flex items-center p-2 text-sm font-normal text-white-600 transition duration-75 group hover:bg-blue-500 dark:text-white dark:hover:bg-gray-700 pl-12">Surat Masuk</a>
                      </li>
                      <li>
                        <a href="#"
                          class="flex items-center p-2 text-sm font-normal text-white-600 transition duration-75 group hover:bg-blue-500 dark:text-white dark:hover:bg-gray-700 pl-12">Surat Keluar</a>
                      </li>
                    </ul>
                  </li>
                  <li>
                    <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6" aria-controls="report" data-collapse-toggle="report">
                        <span class="inline-flex justify-center items-center ml-4">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"></path></svg>
                        </span>
                    ...
                    <ul id="report" class="hidden bg-sky-700 dark:bg-gray-800">
                      <li>
                        <a href="#"
                          class="flex items-center p-2 text-sm font-normal text-white-600 transition duration-75 group hover:bg-blue-500 dark:text-white dark:hover:bg-gray-700 pl-12"> Report Surat Masuk</a>
                      </li>
                      <li>
                        <a href="#"
                          class="flex items-center p-2 text-sm font-normal text-white-600 transition duration-75 group hover:bg-blue-500 dark:text-white dark:hover:bg-gray-700 pl-12">Report Surat Keluar</a>
                      </li>
                    </ul>
                  </li>
                <li>
